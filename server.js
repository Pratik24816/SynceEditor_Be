    ...
    const url = "mongodb+srv://prajapatipm16:3ClpFm4uUsxIKPjM@portfolio.noz1l.mongodb.net/PortfolioDB?retryWrites=true&w=majority&appName=PortFolio";
    ...
    const io=require('socket.io')(3001,{
        cors:{
            origin:"https://synceditor-fe.onrender.com",
            methods:["GET","POST"],
        }
    });
    const defaultValues="";
